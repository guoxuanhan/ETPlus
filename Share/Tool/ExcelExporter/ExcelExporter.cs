...
namespace ET
{
    public static class ExcelExporter
    {
        ...
        /// 配置代码生成父目录
        /// </summary>
        const string GeneratedCodeBaseDir = "../Unity/Assets/Scripts/Codes/Model/Generate";
        ...
        public static void Export()
        {
            ...
            string shellFilePath = RuntimeInformation.IsOSPlatform(OSPlatform.Windows)? ".\\gen.bat" : "./gen.sh";
        ...
        static Process CreateProcess(string cmd, string workDirectory)
        {
            ...
            {
                Arguments = $"{arguments} \"{cmd}\"", CreateNoWindow = false, UseShellExecute = true, WorkingDirectory = workDirectory
            };
            return process;
        }
    }
