...
//                     ReloadPackages();
//                     
//                     string fuiAutoGenDir = $"{fuiCodeSpawnConfig.PackageDir}/Scripts/ModelView/Client/Demo/FUIAutoGen";
//                     string modelViewCodeDir = $"{fuiCodeSpawnConfig.PackageDir}/Scripts/ModelView/Client/Demo/FUI";
//                     string hotfixViewCodeDir = $"{fuiCodeSpawnConfig.PackageDir}/Scripts/HotfixView/Client/Demo/FUI";
//                     
