...
// --------------- 登录流程 ---------------
	...
	[Message(InnerMessage.Queue2G_EnterMap)]
	[ProtoContract]
	...
	[Message(InnerMessage.G2Queue_EnterMap)]
	[ProtoContract]
	...
	[Message(InnerMessage.Queue2G_UpdateInfo)]
	[ProtoContract]
	public partial class Queue2G_UpdateInfo: ProtoObject, IActorMessage
	{
		...
		[ProtoMember(2)]
		public List<int> QueueIndexList { get; set; }
	...
	[ResponseType(nameof(M2G_Disconnect))]
	[Message(InnerMessage.G2M_Disconnect)]
	[ProtoContract]
	public partial class G2M_Disconnect: ProtoObject, IActorLocationRequest
	{
		[ProtoMember(90)]
		public int RpcId { get; set; }
	...
	[Message(InnerMessage.M2G_Disconnect)]
	[ProtoContract]
	public partial class M2G_Disconnect: ProtoObject, IActorLocationResponse
	{
		[ProtoMember(90)]
		public int RpcId { get; set; }
